...
// constants for volume and brightness control
...
/* tagging */
static const char *tags[] = { "__new__", "()", "{}", "[]", "#", "__init__", ";;", "::", "gg" };
...
// command for opening google-chrome
static const char *chrome[] = {"google-chrome", NULL};

// command for opening Telegram
static const char *telegram[] = {"telegram", NULL};

// command for opening qutebrowser
static const char *qutebrowser[] = {"qutebrowser", NULL};

// command for opening pulseaudio volume control
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_a,      spawn,          {.v = pulseaudio } },
...
//	{ MODKEY,                       XK_t,      setlayout,      {.v = &layouts[0]} },// convert to tilling mode
